...
values
  ...
  ('omar_verified', 'omar@seed.pawssafe.local', '+201002222222', 'egypt', 'Giza', 'Password123!', 'user', 'approved', true),
  ('nada_foster', 'nada@seed.pawssafe.local', '+201003333333', 'egypt', 'Alexandria', 'Password123!', 'user', 'approved', true),
